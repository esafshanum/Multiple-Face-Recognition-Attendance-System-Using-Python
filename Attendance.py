...
class Attendance:
    def __init__(self,root):
        ...
        #Time Label
        time_id = Label(l_frame,text="Date :",font=("times new roman",13,"bold","underline"),bg="light blue")
        ...
        #Date Label
        date_id = Label(l_frame,text="Time :",font=("times new roman",13,"bold","underline"),bg="light blue")
